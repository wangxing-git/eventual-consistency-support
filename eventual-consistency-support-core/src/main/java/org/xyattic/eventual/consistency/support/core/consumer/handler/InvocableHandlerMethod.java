...
public class InvocableHandlerMethod extends org.springframework.messaging.handler.invocation.InvocableHandlerMethod {
    ...
    protected ConsumerPersistence getConsumerPersistence(RabbitConsumer rabbitConsumer) {
        return getBean(rabbitConsumer.persistenceName(), ConsumerPersistence.class);
    }
    ...
    protected void saveConsumedMessages(RabbitConsumer rabbitConsumer,
        ...
        try {
            m.put("body", JSONObject.parse(message.getBody()));
